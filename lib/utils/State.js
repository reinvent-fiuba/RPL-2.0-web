...
exports.getState = exports.withState = exports.StateProvider = exports.State = void 0;
...
var State = _react["default"].createContext();
...
var StateProvider = function StateProvider(props) {
  var set = function set(key, value) {
    return setState(function (oldState) {
      var newState = _objectSpread({}, oldState, _defineProperty({}, key, value));

      var localStorageState = JSON.parse(localStorage.getItem("state")) || {};
...
var withState = function withState(Component) {
  return function (props) {
    var state = (0, _react.useContext)(State);
