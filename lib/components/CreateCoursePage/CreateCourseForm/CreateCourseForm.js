...
function (_React$Component) {
  ...
  function CreateCourseForm() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(CreateCourseForm).apply(this, arguments));
  }
  ...
  _createClass(CreateCourseForm, [{
    ...
    value: function handleCreateClick(event) {
      ...
      var _this$state = this.state,
          ...
          universityCourseId = _this$state.universityCourseId,
          semester = _this$state.semester,
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", null, error.open && _react["default"].createElement(_ErrorNotification["default"], {
        ...
        onClick: function onClick(e) {
          return _this2.handleCreateClick(e);
        }
      }, "Crear"))));
    }
  }]);
...
var _default = (0, _State.withState)((0, _styles.withStyles)(styles)(CreateCourseForm));
