...
function (_React$Component) {
  ...
  function SideBar(props, defaultProps) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(SideBar).call(this, props, defaultProps));
    _this.state = {
  ...
  _createClass(SideBar, [{
    ...
    value: function render() {
      ...
      var itemsLinks = {
        Cursos: '/courses',
        Actividades: courseId && "/courses/".concat(courseId, "/activities")
      };
      return _react["default"].createElement(_Drawer["default"], {
        ...
        return _react["default"].createElement("div", null, itemsLinks[text] && _react["default"].createElement(_ListItem["default"], {
          button: true,
          key: text,
