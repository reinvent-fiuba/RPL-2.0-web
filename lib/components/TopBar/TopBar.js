...
function (_React$Component) {
  ...
  function TopBar(props, defaultProps) {
    var _this;

    _classCallCheck(this, TopBar);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(TopBar).call(this, props, defaultProps));
    _this.state = {
  ...
  _createClass(TopBar, [{
    ...
    value: function render() {
      ...
      var _ref = this.props.context && this.props.context.profile,
          name = _ref.name,
          surname = _ref.surname;

      return _react["default"].createElement(_AppBar["default"], {
        position: "fixed",
        className: "".concat(classes.appBar, " ").concat(this.state.open ? classes.appBarShift : '')
      }, _react["default"].createElement(_Toolbar["default"], null, _react["default"].createElement(_IconButton["default"], {
        color: "inherit",
        "aria-label": "open drawer",
        onClick: this.props.handleDrawerOpen,
        edge: "start",
        className: "".concat(classes.menuButton, " ").concat(this.state.open ? classes.hide : '')
