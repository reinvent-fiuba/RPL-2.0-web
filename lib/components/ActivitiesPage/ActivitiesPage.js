...
function (_React$Component) {
  ...
  function ActivitiesPage(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(ActivitiesPage).call(this, props));
  ...
  _createClass(ActivitiesPage, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", null, _react["default"].createElement(_TopBar["default"], {
        handleDrawerOpen: function handleDrawerOpen(e) {
          return _this3.handleSwitchDrawer(e);
        },
        open: open,
        title: "Actividades"
      ...
      }, _react["default"].createElement(_Add["default"], null)), error && _react["default"].createElement(_ErrorNotification["default"], {
        open: _.get(this.state, "error.open"),
        message: _.get(this.state, "error.message")
      }), activities && Object.keys(activitiesByCategory).map(function (category) {
    ...
    key: "renderCategoriyActivities",
    value: function renderCategoriyActivities(activities, classes) {
